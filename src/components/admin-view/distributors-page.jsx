...
import { fetchAllDistributors, updateDistributorStatus } from "@/store/admin/distributor-slice";
...
function AdminDistributorsPage() {
  ...
  <div className="flex justify-between items-center mb-4">
    ...
    <Button
      onClick={() => {
        window.open("http://localhost:5000/api/distributors/export/csv", "_blank");
      }}
