...
function ShoppingHome() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {brandList.map((b) => {
              const Icon =
                b.icon && typeof LucideIcons[b.icon] === "function"
                  ? LucideIcons[b.icon]
                  : null;
              ...
              return (
                ...
                >
                  <CardContent className="flex flex-col items-center justify-center p-6">
                    ...
                    <span className="font-bold text-center">{b.name}</span>
                  </CardContent>
                </Card>
              );
            })}
      ...
      {/* Feature Products with Sale Label */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {productList?.map((p) => {
              ...
              return (
                <div
                  key={p._id}
                  className="relative border rounded-lg shadow-sm hover:shadow-lg transition-all overflow-hidden"
                >
                  {isOnSale && (
